...
HD_PWD='C:/Users/Brooks/Downloads/Lab-01-APUF/Lab-01-APUF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log APUF_CTRL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source APUF_CTRL.tcl -notrace
