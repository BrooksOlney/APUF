...
HD_PWD='C:/Users/Brooks/Downloads/Lab-01-APUF/Lab-01-APUF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log APUF_CTRL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source APUF_CTRL.tcl
